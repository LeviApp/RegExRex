...
export default class LessonComponent extends Component {
  ...
  regexFind() {
    ...
    console.log("this is only a test", this.lessonparaSolid.replace(this.rVal, `<span>$&</span>`), this.lessonparaSolid.replace(this.solution, `<span>$&</span>`))
