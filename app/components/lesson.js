  ...
  regexFind() {
    ...
    console.log(
      ...
      this.lessonparaSolid.replace(this.rVal, `<span>$&</span>`) ===
        this.lessonparaSolid.replace(this.solution, `<span>$&</span>`)
    );
    if (
      this.lessonparaSolid.replace(this.rVal, `<span>$&</span>`) ===
      this.lessonparaSolid.replace(this.solution, `<span>$&</span>`)
