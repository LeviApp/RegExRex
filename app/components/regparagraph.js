...
export default class RegparagraphComponent extends Component {
  @tracked
  para = `Welcome to RegEx Rex! This is a simple application to practice RegEx. Try RegEx expressions with this example or use your own. Simply type in a new paragraph in the second input and hit "Paragraph Submit." The first input is reserved for the RegEx expression. Type in a JavaScript-based RegEx expression, and hit "RegEx Submit."`;
  @tracked
